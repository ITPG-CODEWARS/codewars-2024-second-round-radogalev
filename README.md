...
След това в терминала ще получите отговор съдържащ линк с домейн localhost.Копирайте го сложете го браузър,като google chrome и ще имате достъп до приложението.След като сте минали през тези стъпи, за повторно пускане просто въведете командата: python main.py.
